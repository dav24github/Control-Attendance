        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="horarioEdit" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Título</label>
                                        <input v-model="form.h_nombre" type="text" class="form-control" placeholder="Título">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button class="btn btn-info"><i class="fas fa-edit"></i>&nbspActualizar</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    export default {
        ...
        methods:{
            horarioEdit(){
                ...
                axios.patch('api/horarios/'+id,this.form)
                    .then(res=>{
        ...
        created() {
            let id = this.$route.params.id;
            axios.get('api/Horario_details/'+id)
            .then(res=>{
                this.form = res.data;
