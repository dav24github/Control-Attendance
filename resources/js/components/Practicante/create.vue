                    ...
                    <div class="card-body">
                        <form @submit.prevent="practicanteAdd">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <img :src="form.foto" id="imgHide" style="width:80px;height:100px;display:none" class="foto-fluid mb-1">           
                                </div>                                 
                                <div class="col-md-6">                                   
                                    <div class="form-group">
                                        <button id="btnImg"  style="display:none" class="btn btn-secondary btn-sm"  v-on:click.prevent="clearImg()"><i class="fas fa-times"></i></button>   
                                    </div>
                                </div>                               
...
<script>
    export default {
        ...
        methods:{
            practicanteAdd(){
                axios.post('api/practicantes',this.form)
                .then(res=>{
