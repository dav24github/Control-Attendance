...
let practicanteHistorial = require('./components/Practicante/historial.vue').default;
let practicanteEdit = require('./components/Practicante/edit.vue').default;
let practicanteInfo = require('./components/Practicante/practicanteDetails.vue').default;
...
let historialAsistencia = require('./components/Asistencia/historial.vue').default;
...
let inactividadIndex = require('./components/Inactividad/inactividades.vue').default;
...
export const routes = [
    ...
    // practicante routes
    { path: '/add-practicante', component: practicanteCreate, name: 'practicanteCreate' },
    { path: '/practicantes', component: practicanteIndex, name: 'practicanteIndex' },
    { path: '/historial', component: practicanteHistorial, name: 'practicanteHistorial' },
    { path: '/edit-inactividad/:id', component: practicanteEdit, name: 'practicanteEdit' },
    { path: '/practicante-info/:id', component: practicanteInfo, name: 'practicanteInfo' },
    ...
    { path: '/horario-details/:id', component: horarioDetails, name: 'horarioDetails' },

    // inactividad routes
    { path: '/add-inactividad', component: inactividadCreate, name: 'inactividadCreate' },
    { path: '/inactividades', component: inactividadIndex, name: 'inactividadIndex' },
    { path: '/inactividad-edit/:id', component: inactividadEdit, name: 'inactividadEdit' },
    { path: '/inactividad-search', component: searchInactividad, name: 'searchInact' },
    ...
    //asistencia routes
    { path: '/add-asistencia', component: asistenciaCreate, name: 'asistenciaCreate' },
    { path: '/asistencias', component: asistencias, name: 'asistencias' },
    { path: '/asistencia-search', component: searchAsistencia, name: 'searchAsistencia' },
    { path: '/asistencia-historial', component: historialAsistencia, name: 'historialAsistencia' },

    //retraso routes
    { path: '/retraso-search', component: searchRetraso, name: 'searchRetraso' },
